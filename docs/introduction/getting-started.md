...
This tutorial is intended for those who already have the [PreRequisites](external-secrets/docs/introduction/prerequirements.md) complete. If there is a term that you don't comprehend, we suggest you to take a look at the [Glossary](external-secrets/docs/introduction/glossary.md)  for a general understanding.
